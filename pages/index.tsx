        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="flex flex-col md:flex-row gap-8">
            ...
            <div className="relative md:w-5/12">
              <div
                className="absolute -top-20 md:-top-10 -left-2 md:-left-4 lg:-left-10 xl:-left-10 origin-top-left scale-[0.6] sm:scale-30 md:scale-50 lg:scale-75 xl:scale-90"
                dangerouslySetInnerHTML={{ __html: toptalButton }}
              />
